...
# Database: zen
# Generation Time: 2014-12-13 19:47:15 +0000
# ************************************************************
...
CREATE TABLE `purchase_bill_ex` (
  ...
  CONSTRAINT `purchase_bill_ex_ibfk_5` FOREIGN KEY (`fk.id_product_purchase_price`) REFERENCES `product_purchase_price` (`id_product_purchase_price`) ON UPDATE CASCADE,
...
# Dump of table purchase_return_ex
# ------------------------------------------------------------
